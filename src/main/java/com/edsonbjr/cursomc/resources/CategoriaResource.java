package com.edsonbjr.cursomc.resources;
...
import com.edsonbjr.cursomc.dto.CategoriaDTO;
import com.edsonbjr.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Void> udpate(@Valid @RequestBody CategoriaDTO objDTO, @PathVariable Integer id) {
		Categoria obj = service.fromDTO(objDTO);
		obj.setId(id);
